...
//        long dateTimeMillis = mCursor.getColumnIndex(OffloadContract.TransactionEntry.COLUMN_DATE_TIME);
        ...
        String formattedAmount = DateHelper.getFormattedCurrency(mContext, transactionAmount);
